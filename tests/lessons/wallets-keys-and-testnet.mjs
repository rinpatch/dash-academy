...
const ledgerUrl = new URL("../../lesson-sources/wallets-keys-and-testnet.json", import.meta.url);
const verifierUrl = new URL("./wallets-keys-and-testnet.verify.mjs", import.meta.url);
