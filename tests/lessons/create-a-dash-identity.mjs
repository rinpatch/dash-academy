...
const ledgerUrl = new URL("../../lesson-sources/create-a-dash-identity.json", import.meta.url);
const verifierUrl = new URL("./create-a-dash-identity.verify.mjs", import.meta.url);
