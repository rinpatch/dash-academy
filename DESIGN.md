...
- **Lesson overview** (`app/learn/[[...slug]]/page.tsx`): renders the lesson's MDX body directly beneath the title and metadata.
...
Lessons use ordinary MDX headings, paragraphs, lists, links, code blocks, and callouts. Keep explanations concise and place content in a single linear reading flow.
