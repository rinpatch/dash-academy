...
In this lesson you register a real Platform identity on testnet, fund it from a Platform address you already control, and read its credit balance back from the network.
